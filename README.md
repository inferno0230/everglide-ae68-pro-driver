...
| Report-rate changes and automatic reconnect | Implemented; physical restart should be verified before the first release |
...
- [ ] Verify automatic report-rate reconnection against the physical keyboard.
